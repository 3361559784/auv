...
- `docs/ai/references/2026-06-13-osu-benchmark-p4-plus-roadmap.md` — osu lane; its
...
- `docs/ai/references/2026-06-11-auv-cli-invoke-driver-console-design.md` — invoke
...
- `docs/ai/references/2026-06-11-frontend-convention-v0.md` — one execution model
  (M0 convention).
