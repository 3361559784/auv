...
Start with C1 from `docs/ai/references/2026-06-13-auv-core-lane-roadmap.md` when the owner says go.
...
1. read this handoff
2. read `docs/ai/references/2026-06-13-auv-core-lane-roadmap.md`
