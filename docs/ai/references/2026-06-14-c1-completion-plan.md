...
- `docs/ai/references/2026-06-13-auv-core-lane-roadmap.md` (C1 section + exit criteria)
- `docs/ai/references/2026-06-11-auv-cli-invoke-driver-console-design.md` (namespace model)
- `docs/ai/references/2026-06-14-c1-invoke-registry-handoff.md` (C1a–c state; app-probe fix)
...
- Update `2026-06-14-c1-invoke-registry-handoff.md` status line (regression already
