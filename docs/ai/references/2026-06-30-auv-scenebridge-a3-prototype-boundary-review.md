...
**Prior work:** [A2 boundary review](2026-06-30-auv-scenebridge-a2-boundary-decision-review.md)
(**Package A accepted**) → [A2 evidence pack](2026-06-30-auv-scenebridge-a2-netease-sidebar-evidence-pack.md)
...
| `scope_id = playlist_sidebar` | Memory key matches shipped `ViewRegionRecord.name`, not provisional `netease.playlist_sidebar` alone | [A2 evidence pack](2026-06-30-auv-scenebridge-a2-netease-sidebar-evidence-pack.md) vocabulary table |
...
| Partial reacquire cascade | Stages 1, 3, 5 in `auv-view::memory::reacquire`; stage 4 in live adapter; stages 2, 6 deferred | [anchor-reacquisition-v0](2026-05-29-view-parser-anchor-reacquisition-v0.md) |
| SidebarReacquireAdapter | NetEase calls existing `parse_sidebar_viewport` / region helpers — no `RegionParser` trait extraction | [layer-contracts-v0](2026-05-29-view-parser-layer-contracts-v0.md) (aspirational vs shipped) |
...
| Command JSON inspect | Reacquire `strategy_used`, `observation_count`, stale reason on `PlaylistSelectResult` — not `view.reacquire.*` spans | [inspect-viewer-v0](2026-05-29-view-parser-inspect-viewer-v0.md) deferred |
...
| Spec crate mapping | `auv-example-netease-playlist` in view-parser specs = shipped **`auv-netease-music`** | [example-placement-v0](2026-05-29-view-parser-example-placement-v0.md) |
...
- [view-memory-v0](2026-05-29-view-parser-view-memory-v0.md) — type, lifecycle, done criteria #1–7
- [anchor-reacquisition-v0](2026-05-29-view-parser-anchor-reacquisition-v0.md) — cascade, `ReacquireOutcome`, done criteria #1–7
...
- Root [`catalog.rs`](../../src/catalog.rs) NetEase `command_id`
